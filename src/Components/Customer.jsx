            ...
            <div className='flex items-center w-[80%]'>
                <div className='w-[50%] ml-[50px]'>
                    ...
                    <div className='w-full mt-8'>
                        <p className='text-[20px]'>We needed to have video running on android displays in <br /> different countries. So, we used the Pickcel software. I <br /> liked the report function that lets me see for how long the <br /> stores have the video running. And the support I received <br /> was world-class.</p>
