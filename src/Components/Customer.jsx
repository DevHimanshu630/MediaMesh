                ...
                <div className='flex items-center xl:w-[75%] '>
                    <div className='w-[50%] ml-[20px]'>
                        ...
                        <div className='w-full mt-8'>
                            <p className='2xl:text-[20px] text-justify'>We needed to have video running on android displays in <br /> different countries. So, we used the Pickcel software. I <br /> liked the report function that lets me see for how long the <br /> stores have the video running. And the support I received <br /> was world-class.</p>
