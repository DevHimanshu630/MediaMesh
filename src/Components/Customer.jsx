...
function Customer() {
    return (
        <div className=' w-[100%] flex  justify-center  sm:py-24'>
            <div className='flex justify-center items-center w-[90%] '
                style={{ backgroundImage: 'url("")' }}
            >
                <div className='flex  items-center  w-[100%] 2xl:w-[83%] 3xl:px-10 '>
                    <div className='w-[50%] 2xl:ml-[25px]'>
                    ...
                    <div className='xl:w-[38%] w-[35%] '>
                        <img className='relative left-[49%] md:left-[89%] top-[50px]' src="https://www.pickcel.com/assets/img/icons/shape_163.svg" alt="" />
                        ...
                        <img className='relative  hidden md:block left-[300px] bottom-[180px] ' src="https://www.pickcel.com/assets/img/home/smile-loading-animation.gif" width='80px' height="80px" alt="" />
                    </div>
                </div>
            </div>
        </div>
