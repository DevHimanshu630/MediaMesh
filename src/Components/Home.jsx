...
function Home() {
    return (
        <div className='main__bg'>
            ...
            <Navbar />
            <div className='w-full  flex flex-col gap-3 items-center justify-center h-[70vh] '>
                <h1 class=" text-4xl font-bold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Welcome to the Future of Digital </h1>
                <h1 className='class="mb-4 text-4xl font-bold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white"'>Signage with MediaMesh.</h1>
                <p class=" leading-3 text-lg font-normal text-gray-500 lg:text-4xl sm:px-16 xl:px-48 mt-3 dark:text-gray-400">Engage, Inform, and Inspire with Our State-</p>
