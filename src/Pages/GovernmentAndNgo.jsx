    ...
    return (
        <>
                ...
                <section className="w-[100%] md:py-28 py-[4rem]  flex items-center justify-center">
                    <div className='lg:w-[70%] md:gap-10 flex flex-col justify-center items-center  '>
                        <div className='flex flex-col md:gap-14 items-center justify-center'>
                            <div className='xl:w-[60%] p-5 md:p-0 text-center text-[2rem] md:text-5xl'>
                                <span>Digital Signage for Government and Non-profits</span>
                            </div>
                            <div className='xl:w-[80%] p-5 md:p-0 text-center font-thin text-[1rem] md:text-xl'>
                            ...
                            <section>
                                <div class="flex flex-wrap justify-center   w-fit rounded-full  ">
                                    <a
                                        ...
                                        href="!"
                                        class="button button--aylen md:px-10 md:py-3 py-3 px-6 hover:bg-white text-white relative block focus:outline-none  rounded-full text-[12px] md:text-sm text-center font-semibold   overflow-hidden"
                                    >
                                        Start Free Trial
                                    </a>
                                </div>
                            </section>
                            <a href="#" class="inline-flex items-center text-[12px] md:text-sm  justify-center h-fit px-3 py-2.5 md:px-8 md:py-3  font-medium text-center   rounded-full   border  text-black hover:border-[#ff5100] hover:text-[#ff5100] border-black bg-white ">
                                Schedule My Demo
                            </a>
                        </div>
                    </div>
            ...
            <section className='flex md:py-20  justify-center items-center w-[100%] p-5 md:p-0'>
                <div className="flex flex-wrap gap-5 lg:gap-0 lg:flex-nowrap xl:w-[90%] p-5 xl:p-0 2xl:w-[72%]   items-center  ">

                    <div className='w-[100%] lg:w-auto flex flex-col gap-7  p-0 '>
                        <div className=' lg:text-[3.3rem] text-center lg:text-left md:text-[3rem] text-[2rem] leading-[40px] md:leading-[60px] lg:w-[450px] '>Day-to-day communication made faster</div>
                        <div className="w-[70px] h-[5px] m-auto lg:m-0 rounded-full bg-orange-500"></div>
                    </div>

                    <div className='grid md:grid-cols-2  gap-6 h-[80vh] scrollbar-hide overflow-y-scroll '>
            ...
            <div className="w-[100%] lg:h-[50vh] p-5 md:p-9 lg:p-0 flex flex-col lg:flex-row    justify-around  items-center  mt-[20px]">
                <div className="lg:w-[35%]  2xl:ml-[12%]">
                    <div>
                        <h1 className="md:text-[48px] text-[2rem]  leading-none text-center md:text-left md:leading-[50px] ">
                            On-premise solution for maximum control.
                        </h1>
                        <p className="text-[18px] text-center md:text-left  font-thin mt-[30px]">
                        ...
                        <p className='my-3 text-xl text-center md:text-left  text-[#ff5100]'>View On-premise solution</p>
                    </div>
            ...
            }} className="w-[100%] lg:h-[70vh] p-5 md:p-9 lg:p-0 flex flex-col gap-[5rem] lg:flex-row py-10    justify-around  items-center  mt-[20px]">
                <div className="lg:w-[35%]  2xl:ml-[12%]">
                    <div>
                        <h1 className="md:text-[40px] text-[2rem] leading-none text-center md:text-left  md:leading-[50px] ">
                            Queue management solution with Pickcel
                        </h1>
                        <p className="text-[18px] mt-[30px] text-center md:text-left  font-thin">
                    ...
                    <div className="flex gap-3  justify-center lg:justify-start  mt-[30px]">
            ...
            <div className='2xl:pl-12 mt-[5rem] lg:mt-0'>
                <RetailBussiness
                    heading={h.heading}
