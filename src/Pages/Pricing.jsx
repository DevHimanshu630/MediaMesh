...
function Pricing() {
  ...
  const handlePrice = () => {
    // Update monthPrice with new values
    
    setmonthPrice({
        Basic: 20, // new value for Basic
        Popular: 150, // new value for Popular
        Enterprise: 250, // new value for Enterprise
      })
    setIsToggle(false) 
  };
      ...
      <div className="flex flex-col p-4 items-center justify-center gap-10 pt-8 md:pt-20 md:pb-10">
        <div className="md:w-[70%] flex p-2 md:p-0 flex-col md:gap-7 gap-3 items-center justify-center  md:h-44">
          <h1 className="md:text-5xl text-2xl text-center">
            Pick a plan that suits your business size
          </h1>
          <div className="flex items-center  justify-center gap-4">
            <span class="ms-3 text-sm font-normal text-gray-900 dark:text-gray-300">
              Monthly
            </span>
            <label class="relative flex items-center cursor-pointer" onClick={handlePrice}>
              ...
              <span class="ms-3 text-sm font-normal -z-10 text-gray-900 dark:text-gray-300">
                Annually
              </span>
            </label>
          </div>
          <p className="md:text-3xl  font-medium  text-amber-700">
            Save 10% <span className="font-thin">on annual plan</span>
          </p>
        </div>
        <div className="md:flex-row  w-full flex p-3 md:p-0 flex-col items-center justify-center gap-3 2xl:gap-10 ">
          <div class="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            <h5 class="mb-4 text-xl font-medium text dark:text-gray-400">
              Business
            </h5>
            <hr className=" " />
            ...
            <div className="flex-col py-2 pt-5  flex gap-1 hover:font-semibold">
              <a
                href="#"
                class="inline-flex items-center  border hover:border-[#ff5100] hover:text-[#ff5100] justify-center px-8 py-3  text-[10px] xl:text-base font-medium text-center text-black rounded-full"
              >
            ...
            <ul role="list" class="mspace-y-5 my-7 gap-5 flex flex-col">
              <li class="flex items-center">
                <svg
                  class="flex-shrink-0 w-4 h-4 text-gray-200 dark:text-blue-500"
                  aria-hidden="true"
              ...
              <li class="flex  decoration-gray-500">
                <svg
                  class="flex-shrink-0 w-4 h-4 text-gray-200 dark:text-gray-500"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 20 20"
              ...
              <li class="flex  decoration-gray-500">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">
                  API acccess & Zapier integration
                </span>
              </li>
              <li class="flex  decoration-gray-500">
                <svg
            ...
            <button
              type="button"
              class="text-white bg-gradient-to-r from-[#fd0036] via-[#ff5100] to-[#ffa800] hover:shadow-lg hover:bg-[#ff5100]focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center"
            >
              Choose plan
            </button>
          </div>
          <div class="w-full  max-w-sm p-4 bg-white  border border-[#ff5100] rounded-lg shadow-md sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            <h5 class="mb-4 text-xl font-medium text-[#ff5100] dark:text-gray-400">
              Most Popular
            </h5>
            ...
            <ul role="list" class="space-y-5 my-7">
              ...
              <li class="flex">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">
                  Supported on all media players- Android, Windows, Linux,
                  Samsung, LG, etc
                </span>
              </li>
              <li class="flex  decoration-gray-500">
              ...
              <li class="flex  decoration-gray-500">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">
                  In-built graphic design tool (Artboard)
                </span>
              </li>
              <li class="flex  decoration-gray-500">
                <svg
              ...
              <li class="flex  decoration-gray-500">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">
                  60+ signage content apps & integrations
                </span>
              </li>
              ...
              <li class="flex  decoration-gray-500">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">
                  Unlimited screen templates with multiple zones
                </span>
              </li>
              <li class="flex  decoration-gray-500">
                <svg
              ...
              <li class="flex  decoration-gray-500">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">
                  Downloadable reports & proof of play
                </span>
              </li>
              <li class="flex  decoration-gray-500">
                <svg
          ...
          <div class="w-full max-w-sm p-4  bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            <h5 class="mb-4 text-xl font-medium text dark:text-[#ff5100]">
              Enterprise
            </h5>
            <hr className=" " />
            <div class="flex py-3 items-baseline text-gray-900 dark:text-white">
              <span class="text-3xl font-semibold">$</span>
              <span class="text-5xl font-extrabold tracking-tight">
                {monthPrice.Enterprise}
              </span>
              <span class="ms-1 text-xl font-normal text-gray-500 dark:text-blue-600">
                /month
              </span>
            </div>
            <div className="flex-col py-2 pt-5 flex gap-1 hover:font-semibold">
            ...
            <ul role="list" class="space-y-5 my-7">
              ...
              <li class="flex">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 dark:text-gray-400 ms-3">
                  Dedicated / on-premise implementation{" "}
                </span>
              </li>
              <li class="flex">
                <svg
              ...
              <li class="flex  decoration-gray-500">
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">
                  Custom content app development
                </span>
              </li>
              <li class="flex  decoration-gray-500">
                <svg
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">
                  Custom integration with external/enterprise applications
                </span>
              </li>
              <li class="flex  decoration-gray-500">
                <svg
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">
                  Custom signage player app to accommodate specific needs
                </span>
              </li>
              <li class="flex  decoration-gray-500">
                <svg
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">
                  Custom Android launcher APK for remote device management
                </span>
              </li>
              <li class="flex  decoration-gray-500">
                <svg
                ...
                <span class="text-base font-normal leading-tight text-gray-500 ms-3">
                  Custom interactive touchscreen app development
                </span>
              </li>
              <li class="flex  decoration-gray-500">
                <svg
