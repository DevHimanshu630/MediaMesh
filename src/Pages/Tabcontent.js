  ...
  return (
    <div className="w-full  ">
      <div className="tabs flex gap-[20px] mt-[5rem] w-full  text-center justify-center">
        <button onClick={() => handleTabClick("tab1")} className="flex text-center gap-[5px] items-center text-gray-500 border rounded-[30px] hover:border-[#ec1313] hover:text-[#ec1313] text-[18px] p-2 px-4 ">
          <img width='18px' height='18px' src="data:image/svg+xml;base64," />
           Digital Menu Board</button>
